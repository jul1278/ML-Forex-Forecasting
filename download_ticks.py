...
def download_prices():
    ...
    for month in range(1,2):
        ...
        full_url_str_yr = urlparse.urljoin(base_url_str, year_str)
        full_url_str = urlparse.urljoin(full_url_str_yr + '/', page_str)
        ...
        for zip_file_str in zip_files:
            zip_url = urlparse.urljoin(full_url_str + '/', zip_file_str)
            ...
            zip_file = zipfile.ZipFile(StringIO.StringIO(f.content))
            zip_file.printdir()
